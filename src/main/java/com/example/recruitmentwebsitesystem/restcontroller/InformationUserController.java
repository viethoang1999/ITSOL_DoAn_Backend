...
import com.example.recruitmentwebsitesystem.generic.impl.GenericGenericResponse;
...
public class InformationUserController {
    ...
    public ResponseEntity<?> getInformationUserById(@PathVariable("id") Integer id){
        try {
            ...
            GenericGenericResponse<Object> response = new GenericGenericResponse<Object>(new Date(), HttpStatus.OK,
                    "Thành công", result);
