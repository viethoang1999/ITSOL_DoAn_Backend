...
public class CustomUserDetail implements UserDetails,OAuth2User {
    ...
    public CustomUserDetail(Integer id, String username, String passWord, String avatar, String fullname, String email, String phone, String gender, Integer user_status, String homeTown, Date birthday, boolean isDelete, Collection<? extends GrantedAuthority> authorities) {
        this.id = id;
